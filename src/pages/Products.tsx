...
export default function ProductsPage() {
  ...
  // استخراج نام‌های دسته‌بندی یکتا برای فیلتر (فقط دسته‌های اصلی، یا همه)
  ...
  // ذخیره (افزودن/ویرایش) - تغییر در state
  const handleSave = () => {
        ...
        <table className="min-w-full divide-y divide-gray-700">
          ...
          <tbody className="divide-y divide-gray-700 bg-gray-800">
            {filteredProducts.length === 0 ? (
              <tr>
                <td colSpan={5} className="px-6 py-12 text-center text-gray-500">محصولی یافت نشد.</td>
              </tr>
            ) : (
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                >
                  ...
                  {/* یا از categories اصلی: categories.filter(c => !c.parentId).map(...) */}
                </select>
              </div>
            </div>
